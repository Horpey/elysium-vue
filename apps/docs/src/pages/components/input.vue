  ...
  <ElyDocLayout>
    ...
    <div class="my-4">
      <p class="text-sm leading-relaxed">
        Elevate user interaction with our Input component. Effortlessly gather user input, enhance form elements, and provide a seamless data entry experience in your application.
      </p>
